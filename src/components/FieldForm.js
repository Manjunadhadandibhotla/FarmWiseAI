    ...
    return (
      <>
        <form onSubmit={handleSubmit} className="field-form">
          <label>
            ...
            <div className="dropdown-container">
              ...
              >
                ...
                <option className="option1" value="Student">
                  Student
                </option>
                <option className="option1" value="Salaried">
                  Salaried
                </option>
                <option className="option1" value="Business">
                  Business
                </option>
              </select>
            </div>
          ...
          <button type="submit" disabled={fieldCount >= 4}>
            Confirm
          </button>
        </form>
